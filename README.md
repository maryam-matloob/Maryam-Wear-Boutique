...
- [x] index.html, admin.html, style.css, app.js, admin.js, db.json, README.md present
- [x] README has description, setup steps, features, screenshots
- [x] `npx json-server  db.json` works from project folder
- [x] index.html shows products fetched from JSON Server
- [x] Admin CRUD tested for all 4 HTTP methods
- [x] No node_modules in the zip
- [x] No hardcoded arrays in JS files
- [x] No leftover console.log statements
- [x] Name and roll number in README header
